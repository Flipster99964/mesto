...
const imagePopupImage = document.querySelector('.popup_imagePopup__image');
const imageCloseButton = document.querySelector('.popup_imagePopup__close-button');
const imagePopupText = document.querySelector('.popup_imagePopup__text');
